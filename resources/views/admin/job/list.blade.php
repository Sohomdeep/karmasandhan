            ...
            <table class="table table-striped table-bordered" id="responsiveTable">
                ...
                {{-- @if(!$lists->isEmpty())
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>{{-- @if(isset($list->outlet_has_one_distributor_outlet_mapping->distributor->distributor_name)){{$list->outlet_has_one_distributor_outlet_mapping->distributor->distributor_name}}@else -- @endif --}}</td>
                        <td>
