...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Edit Sector</h4>
        </div><!-- /page-title -->
    </div><!-- /main-header -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form id="edit-form" action="{{route('do-edit-sector')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="sector_id" value="{{$sector_details->id}}">
                            <div class="form-group">
                                <label>Name <span class="requireStar">*</span></label>
                                <input type="text" name="sector_name" id="sector_name" class="form-control input-sm" maxlength="60" value="{{$sector_details->sector_name}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <label class="label-radio inline">
                                        <input type="radio" name="active_inactive" value="1" @if($sector_details->is_active == 1) checked @endif>
                                        <span class="custom-radio"></span>
                                        Active
                                    </label>
                                    <label class="label-radio inline">
                                        <input type="radio" name="active_inactive" value="0" @if($sector_details->is_active == 0) checked @endif>
                                        <span class="custom-radio"></span>
                                        Inactive
                                    </label>
                                </div>
