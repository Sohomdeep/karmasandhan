...
<script>
    ...
    $(function(){
        ...
        $(".changeStatusClass").change(function(){
            ...
            $.ajax({
                    type: "GET",
                    url: '{{route("sector-status-update")}}',
                    data:{'sector_id':sector_id,'status':setStatusVal},
    ...
    function confirm_alert(sector_id){
        jConfirm('Are you sure you want to delete this sector?', 'Confirmation', function(r) {
            if(r){
                if(sector_id != ''){
                    window.location.href = '{{route("delete-sector",["sector_id"=>""])}}/'+sector_id;
                }
            }
        });
    }
...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Sector List</h4>
        </div><!-- /page-title -->
        <div class="tools">
            <a href="{{route('add-sector')}}" class="btn btn-circle btn-info btn-sm" style="float: right;">
        ...
        <div style="margin-left: 7px;">
            <div class="row">
                <form action="" method="GET" id="searchForm">
                    ...
                    <div class="col-md-1">
                        <button type="button" class="btn btn-info" onclick="window.location.href ='{{route("sector-list")}}';">Clear search</button>
                    </div>
                </form>
            </div>
        </div>
