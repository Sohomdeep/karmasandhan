...
<script>
    ...
    $(function(){
        ...
        $(".changeStatusClass").change(function(){
            ...
            $.ajax({
                    ...
                    data:{'location_id':location_id,'status':setStatusVal},
    ...
    function confirm_alert(location_id){
        jConfirm('Are you sure you want to delete this location?', 'Confirmation', function(r) {
            if(r){
                if(location_id != ''){
                    window.location.href = '{{route("delete-location",["location_id"=>""])}}/'+location_id;
                }
            }
        });
    }
...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Location List</h4>
        </div><!-- /page-title -->
        <div class="tools">
            <a href="{{route('add-location')}}" class="btn btn-circle btn-info btn-sm" style="float: right;">
        ...
        <div style="margin-left: 7px;">
            <div class="row">
                <form action="" method="GET" id="searchForm">
                    ...
                    <div class="col-md-1">
                        <button type="button" class="btn btn-info" onclick="window.location.href ='{{route("location-list")}}';">Clear search</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered" id="responsiveTable">
                ...
                @if(isset($lists) && !$lists->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('edit-location',['location_id'=>$list->id])}}" title="Edit"><button type="button" class="btn btn-round btn-xs btn-primary"><i class="fa fa-edit"></i></button></a>
