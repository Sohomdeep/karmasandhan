...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Add Location</h4>
        </div><!-- /page-title -->
    </div><!-- /main-header -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form id="add-form" action="{{route('do-add-location')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Name <span class="requireStar">*</span></label>
                                <input type="text" name="location_name" id="location_name" class="form-control input-sm" maxlength="60">
                            </div>
