...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Add Skill</h4>
        </div><!-- /page-title -->
    </div><!-- /main-header -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form id="add-form" action="{{route('do-add-skill')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Name <span class="requireStar">*</span></label>
                                <input type="text" name="skill_name" id="skill_name" class="form-control input-sm" maxlength="60">
                            </div>
