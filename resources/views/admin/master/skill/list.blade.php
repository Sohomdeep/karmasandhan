...
<script>
    ...
    $(function(){
        ...
        $(".changeStatusClass").change(function(){
            ...
            $.ajax({
                    ...
                    data:{'skill_id':skill_id,'status':setStatusVal},
    ...
    function confirm_alert(skill_id){
        jConfirm('Are you sure you want to delete this skill?', 'Confirmation', function(r) {
            if(r){
                if(skill_id != ''){
                    window.location.href = '{{route("delete-skill",["skill_id"=>""])}}/'+skill_id;
                }
            }
        });
    }
...
<div id="main-container">
    <div class="main-header clearfix">
        <div class="page-title">
            <h4 class="no-margin">Skill List</h4>
        </div><!-- /page-title -->
        <div class="tools">
            <a href="{{route('add-skill')}}" class="btn btn-circle btn-info btn-sm" style="float: right;">
        ...
        <div style="margin-left: 7px;">
            <div class="row">
                <form action="" method="GET" id="searchForm">
                    ...
                    <div class="col-md-1">
                        <button type="button" class="btn btn-info" onclick="window.location.href ='{{route("skill-list")}}';">Clear search</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered" id="responsiveTable">
                ...
                @if(isset($lists) && !$lists->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('edit-skill',['skill_id'=>$list->id])}}" title="Edit"><button type="button" class="btn btn-round btn-xs btn-primary"><i class="fa fa-edit"></i></button></a>
